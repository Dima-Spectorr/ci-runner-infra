...
module "ci_cache_warmer" {
  source = "git::https://github.com/<owner>/ci-runner-infra.git//modules/ci-runner-cache-warmer?ref=v5.104.0"
...
entire dependency tree and then died on that check. The install is best effort:
