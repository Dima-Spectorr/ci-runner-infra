...
module "ci_runner_apply_identity" {
  source = "git::https://github.com/<owner>/ci-runner-infra.git//modules/ci-runner-apply-identity?ref=v5.40.0"
...
module "ci_host_image_trigger" {
  source = "git::https://github.com/<owner>/ci-runner-infra.git//modules/ci-host-image-trigger?ref=v5.40.0"
